...
dfa = read.csv2(file = "Y00/DATA/csv/baf08v2.csv", header = TRUE, sep = ",")
dfb = read.csv2(file = "Y00/DATA/csv/baf09dib.csv", header = TRUE, sep = ",")
dfc = read.csv2(file = "Y00/DATA/csv/baref.csv", header = TRUE, sep = ",")
...
dfd = read.csv2(file = "Y00/DATA/csv/caf08.csv", header = TRUE, sep = ",")
dfe = read.csv2(file = "Y00/DATA/csv/caf08.csv", header = TRUE, sep = ",")
...
dfg = read.csv2(file = "Y00/DATA/csv/daf08.csv", header = TRUE, sep = ",")
dfh = read.csv2(file = "Y00/DATA/csv/daf08.csv", header = TRUE, sep = ",")
dfi = read.csv2(file = "Y00/DATA/csv/daref.csv", header = TRUE, sep = ",")
dfj = read.csv2(file = "Y00/DATA/csv/daglu.csv", header = TRUE, sep = ",")
...
dfk = read.csv2(file = "Y00/DATA/csv/eaf08.csv", header = TRUE, sep = ",")
dfl = read.csv2(file = "Y00/DATA/csv/eaf08.csv", header = TRUE, sep = ",")
dfm = read.csv2(file = "Y00/DATA/csv/earef.csv", header = TRUE, sep = ",")
dfn = read.csv2(file = "Y00/DATA/csv/eaglu.csv", header = TRUE, sep = ",")
dfo = read.csv2(file = "Y00/DATA/csv/eaglu.csv", header = TRUE, sep = ",")
...
dfp = read.csv2(file = "Y00/DATA/csv/faf08.csv", header = TRUE, sep = ",")
dfq = read.csv2(file = "Y00/DATA/csv/faf08.csv", header = TRUE, sep = ",")
dfr = read.csv2(file = "Y00/DATA/csv/faref.csv", header = TRUE, sep = ",")
dfs = read.csv2(file = "Y00/DATA/csv/faglu.csv", header = TRUE, sep = ",")
dft = read.csv2(file = "Y00/DATA/csv/faref.csv", header = TRUE, sep = ",")
...
dfu = read.csv2(file = "Y00/DATA/csv/gaf08.csv", header = TRUE, sep = ",")
dfv = read.csv2(file = "Y00/DATA/csv/gaf08.csv", header = TRUE, sep = ",")
dfw = read.csv2(file = "Y00/DATA/csv/garef.csv", header = TRUE, sep = ",")
dfx = read.csv2(file = "Y00/DATA/csv/gaglu.csv", header = TRUE, sep = ",")
dfy = read.csv2(file = "Y00/DATA/csv/gaglu.csv", header = TRUE, sep = ",")
...
dfz = read.csv2(file = "Y00/DATA/csv/haf08.csv", header = TRUE, sep = ",")
dfaa = read.csv2(file = "Y00/DATA/csv/haf08.csv", header = TRUE, sep = ",")
dfab = read.csv2(file = "Y00/DATA/csv/haref.csv", header = TRUE, sep = ",")
dfac = read.csv2(file = "Y00/DATA/csv/haglu.csv", header = TRUE, sep = ",")
dfad = read.csv2(file = "Y00/DATA/csv/haglu.csv", header = TRUE, sep = ",")
