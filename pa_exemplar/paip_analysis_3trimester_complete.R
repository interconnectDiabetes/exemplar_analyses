...
mypath <- file.path('~','plots','model_2a.png')
png(file=mypath, width = 1260*3, height = 940*3, res = 216)
par(mar=c(5,3,2,2)+0.1)
#mypath2 <- file.path('~','plots','model_2.pdf')
#pdf(file = mypath2,width = 1260, height = 940)
par(mfrow=c(3,3))
